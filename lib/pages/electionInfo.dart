...
class _ElectionInfoState extends State<ElectionInfo> {
  TextEditingController addCandidatController = TextEditingController();
        ...
        child: Column(children: [
          ...
          Row(
            children: [
              Expanded(
                child: TextField(
                  controller: addCandidatController,
                  decoration: InputDecoration(hintText: 'Enter Candidate Name'),
                ),
              ),
              ElevatedButton(
                  onPressed: () {
                    addCandidate(addCandidatController.text, widget.ethClient);
                  },
